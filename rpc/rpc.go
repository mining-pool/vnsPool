...
func NewRPCClient(name, url, timeout string) *RPCClient {
	...
	if timeoutIntv > time.Second*2 {
		timeoutIntv = time.Second * 2
	}
...
func (r *RPCClient) GetWork() ([]string, error) {
	rpcResp, err := r.doPost(r.Url, "vns_getWork", []string{})
	if err != nil {
		return nil, err
	}
	var reply []string
...
func (r *RPCClient) GetPendingBlock() (*GetBlockReplyPart, error) {
	rpcResp, err := r.doPost(r.Url, "vns_getBlockByNumber", []interface{}{"pending", false})
	if err != nil {
		return nil, err
	}
...
func (r *RPCClient) GetBlockByHeight(height int64) (*GetBlockReply, error) {
	...
	return r.getBlockBy("vns_getBlockByNumber", params)
}
...
func (r *RPCClient) GetUncleByBlockNumberAndIndex(height int64, index int) (*GetBlockReply, error) {
	...
	return r.getBlockBy("vns_getUncleByBlockNumberAndIndex", params)
}
...
func (r *RPCClient) SubmitBlock(params []string) (bool, error) {
	rpcResp, err := r.doPost(r.Url, "vns_submitWork", params)
	if err != nil {
		return false, err
	}
	var reply bool
