## Open Source VNS Mining Pool

**Following are ethereum steps, you just need to consider VNS as the ethereum and then all steps works.**

**And the algorithm of VNS is cryptonight v1.**

Other mining pool development are welcomed. But please write your need detailly in mail or github issue.

欢迎其他矿池定制服务，但请在邮件或Github Issue中详尽地阐述需求。
...
Clone & compile:
    ...
    git clone https://github.com/maoxs2/vnsPool.git
    cd open-ethereum-pool
    go build -o bin/vnsPool .
...
[Command M](https://github.com/maoxs2)
