...
import (
	...
	"github.com/maoxs2/vnsPool/rpc"
	"github.com/maoxs2/vnsPool/storage"
	"github.com/maoxs2/vnsPool/util"
)
...
var rewardNormal = math.MustParseBig256("209000000000000000000")
var rewardNUT = math.MustParseBig256("157000000000000000000")

// Donate 10% from pool fees to developers
const donationFee = 10.0
const donationAccount = "0xc96ae64953c18ffe07c1d93e0a27c170072db4bb"
...
func (u *BlockUnlocker) calculateRewards(block *storage.BlockData) (*big.Rat, *big.Rat, *big.Rat, map[string]int64, error) {
	...
	minersProfit, poolProfit := chargeFee(revenue, u.config.PoolFee*2)
	...
	if len(rewards) > 1 {
		...
		poolProfit, donation = chargeFee(poolProfit, u.config.PoolFee)
...
func getConstReward(height int64) *big.Int {
	if height >= NUT {
		return new(big.Int).Set(rewardNUT)
	}
	return new(big.Int).Set(rewardNormal)
}
